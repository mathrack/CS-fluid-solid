...
cs_user_periodicity(void)
{
  ...
  /* ---------------------------------------------- */
    ...
    const double translationx[3] = {6.283, 0.0, 0.0}; /* X-Translation vector */
    const double translationy[3] = {0.0, 2.0, 0.0};   /* Y-Translation vector */
    const double translationz[3] = {0.0, 0.0, 3.142}; /* Z-Translation vector */

    join_num = cs_join_perio_add_translation("x<=0.04 or x>=6.243",//=0.0 or x>=6.283",
                                             fraction,
                                             plane,
                                             verbosity,
                                             visualization,
                                             translationx);
/*    join_num = cs_join_perio_add_translation("y<=-1.0 or y>=1.0",
                                             fraction,
                                             plane,
                                             verbosity,
                                             visualization,
                                             translationy);
*/
    join_num = cs_join_perio_add_translation("z<=0.02 or z>=3.122",//=0.0 or z>=3.142",
                                             fraction,
                                             plane,
                                             verbosity,
                                             visualization,

...
plot(y_dns,ryy_dns,'-',color='k',label=r'$DNS$')
plot(nomod.y,nomod.ryy,'--',color='r',label=r'$No.mod.$')
plot(smag.y,smag.ryy,'--',color='g',label=r'$Smag.$')
plot(wale.y,wale.ryy,'--',color='b',label=r'$Wale$')
plot(dyn0.y,dyn0.ryy,'-.',color='r',label=r'$Dyn.(def.)$')
plot(dyn1.y,dyn1.ryy,'-.',color='b',label=r'$Dyn.(clip)$')
plot(dyn0b.y,dyn0b.ryy,':',color='r',label=r'$Dyn.(def.)+<>$')
plot(dyn1b.y,dyn1b.ryy,':',color='b',label=r'$Dyn.(clip)+<>$')

legend(bbox_to_anchor=(1.6,0.9),numpoints=1)

savefig("ryy.png",bbox_inches='tight')
savefig("ryy.pdf",bbox_inches='tight')

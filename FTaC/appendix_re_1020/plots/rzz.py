...
plot(y_dns,rzz_dns,'-',color='k',label=r'$DNS$')
plot(nomod.y,nomod.rzz,'--',color='r',label=r'$No.mod.$')
plot(smag.y,smag.rzz,'--',color='g',label=r'$Smag.$')
plot(wale.y,wale.rzz,'--',color='b',label=r'$Wale$')
plot(dyn0.y,dyn0.rzz,'-.',color='r',label=r'$Dyn.(def.)$')
plot(dyn1.y,dyn1.rzz,'-.',color='b',label=r'$Dyn.(clip)$')
plot(dyn0b.y,dyn0b.rzz,':',color='r',label=r'$Dyn.(def.)+<>$')
plot(dyn1b.y,dyn1b.rzz,':',color='b',label=r'$Dyn.(clip)+<>$')

legend(bbox_to_anchor=(1.6,0.9),numpoints=1)

savefig("rzz.png",bbox_inches='tight')
savefig("rzz.pdf",bbox_inches='tight')

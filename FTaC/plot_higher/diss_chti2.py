...
iscal = 1
plot(wale.scal[iscal].y[31:],-wale.scal[iscal].diss[31:],'-',color='k',label=r'$isoQ$',markerfacecolor='none',markeredgecolor='k')

iscal = 3
for x in range(0, 7):
     plot(append(wale.scal[iscal+7*x].y[:31],0),append(-wale.scal[iscal+7*x].diss[:31],wale.eps_fs[iscal+7*x-2]),'--',color='g')
     plot(insert(wale.scal[iscal+7*x].y[31:],0,0),insert(-wale.scal[iscal+7*x].diss[31:],0,wale.epf_fs[iscal+7*x-2]),'--',color='g')
plot(wale.scal[iscal+7*x].y[:31],-wale.scal[iscal+7*x].diss[:31],'--',color='g',label=r'$K=0.2$')

iscal = 0
plot(wale.scal[iscal].y[31:],-wale.scal[iscal].diss[31:],':',color='k',label=r'$isoT$',markerfacecolor='none',markeredgecolor='k')
...
axis([0,2,0.,0.14])
iscal = 1
plot(wale.scal[iscal].y[31:],-wale.scal[iscal].diss[31:],'-',color='k',markerfacecolor='none',markeredgecolor='k')
iscal = 3
for x in range(0, 7):
     plot(append(wale.scal[iscal+7*x].y[:31],0),append(-wale.scal[iscal+7*x].diss[:31],wale.eps_fs[iscal+7*x-2]),'--',color='g')
     plot(insert(wale.scal[iscal+7*x].y[31:],0,0),insert(-wale.scal[iscal+7*x].diss[31:],0,wale.epf_fs[iscal+7*x-2]),'--',color='g')
...
savefig("diss_chti2.png",bbox_inches='tight')
savefig("diss_chti2.pdf",bbox_inches='tight')

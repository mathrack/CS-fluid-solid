...
xlabel(r"$log_{10}(G)$")
ylabel(r"$log_{10}(K)$")
title(r"Contour plot of $\overline{T'^2}$")

levels = [0.1,0.4,1,2,3,4.,4.8]
CS = contour(log10(wale.gg),log10(wale.kk),wale.ttfs_mat,levels,colors='k')
fmt = r'%4.2f'
clabel(CS, inline=True, fmt=fmt, fontsize=20)

savefig("contour_tt.png",bbox_inches='tight')
savefig("contour_tt.pdf",bbox_inches='tight')

...
xlabel(r"$log_{10}(G)$")
ylabel(r"$log_{10}(K)$")
title(r"Contour plot of $\varepsilon_{\theta,s} / \varepsilon_{\theta,f}$")

levels = [0.02,0.05,0.2,0.5,2.0,5.0,10.0,15.0]
CS = contour(log10(wale.gg),log10(wale.kk),wale.eps_fs_mat/wale.epf_fs_mat,levels,colors='k')
fmt = r'%4.2f'
clabel(CS, inline=True, fmt=fmt, fontsize=20)

savefig("contour_ratio_eps.png",bbox_inches='tight')
savefig("contour_ratio_eps.pdf",bbox_inches='tight')

...
title(r"Cases $G=0.1$ and $K\approx0.2$")
...
legend(bbox_to_anchor=(0.49,0.5),numpoints=1)

savefig("diss_g01k02.png",bbox_inches='tight')
savefig("diss_g01k02.pdf",bbox_inches='tight')

...
#plot(insert(y_sol_les,42,0),insert(tt_les,42,3.861983606E-02),'--+',color='g',markerfacecolor='none',markeredgecolor='g')
plot(insert(y_sol_les,42,0),insert(tt_les,42,3.795261432E-02),'--+',color='g',markerfacecolor='none',markeredgecolor='g')
...
savefig("395_diss.png",bbox_inches='tight')
savefig("395_diss.pdf",bbox_inches='tight')
